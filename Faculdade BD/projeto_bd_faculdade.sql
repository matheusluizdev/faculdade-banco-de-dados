CREATE DATABASE IF NOT EXISTS db_Faculdade CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE db_Faculdade;
...
INSERT INTO Endereco_Aluno (RA, Nome_Rua, Num_Rua, Complemento, CEP)
VALUES
(2, 'das Giestas', 255, 'Casa 02', 02854000),
(3, 'Lorena', 10, 'Apto 15', 02945000),
(1, 'do Cursino', 1248, '', 0851040),
(4, 'das Heras', 495, '', 03563142),
(5, 'Santos', 1856, '', 04523963),
(6, 'Matão', 206, '', 04213650);
